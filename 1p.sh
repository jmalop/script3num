...
nmap -sU --top-ports 15000 --max-rtt-timeout 10 --max-scan-delay 2 --min-hostgroup 10 --reason --min-rate 2000 $1 -n >> temp3

#sudo nmap -sU -p- --open -sV --version-intensity 1 $1 -n -Pn  | tail -n +6 | head -n -1 >> temp3
...
do
        ...
        then
               ...
               nmap -sU -sV --script "ntp* and (discovery or vuln) and not (dos or brute)" --reason --min-rate 5000 -p 123 $1 | tail -n +5 | head -n -1  > tempntp
